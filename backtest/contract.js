...
const DEFAULT_CONTRACT_PATH = path.join(__dirname, "contracts", "strategy-v11.json");
...
function validateBacktestContract(contract, options = {}) {
  ...
  const isV10 = ["v10", "v11"].includes(contractVersion);
  const isMinuteSell = ["v7", "v8", "v9", "v10", "v11"].includes(contractVersion);
  ...
  if (!["v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10", "v11"].includes(contractVersion)) reasons.push("contract_version_unsupported");
...
function inspectBacktestExecutionReadiness(contract, input = {}, options = {}) {
  ...
  if (!["v7", "v8", "v9", "v10", "v11"].includes(String(source.contractVersion || ""))) {
...
function createBacktestRunManifest(contract, input = {}) {
  ...
  if (["v7", "v8", "v9", "v10", "v11"].includes(String(contract.contractVersion || ""))
  ...
  const identity = {
    ...
    lane,
    ...(["v7", "v8", "v9", "v10", "v11"].includes(String(contract.contractVersion || "")) ? { sellVariant } : {}),
    runConfig,
  };
  return {
    schemaVersion: 1,
